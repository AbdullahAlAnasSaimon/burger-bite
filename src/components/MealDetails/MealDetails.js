...
const MealDetails = () => {
  ...
  const replacedYouTube = sliceYouTube.replace(sliceYouTube, `https://www.youtube.com/embed/`);
  const sliceYouTube2 = strYoutube.slice(32, 43);
  const finalYoutube = replacedYouTube + sliceYouTube2;

  return (
    <div className='mt-10 pb-20'>
      <h1 className='text-3xl text-center'>{strMeal}</h1>
      <div className='flex flex-col lg:flex-row justify-evenly'>
        <img className='inline-block my-5 w-10/12 lg:w-5/12 rounded-md mx-auto lg:mx-0' src={strMealThumb} alt="" />
        <iframe className='my-5 rounded-md w-10/12 lg:w-5/12 mx-auto lg:mx-0' height='526' src={finalYoutube} title="YouTube video player" frameBorder="0" allowFullScreen></iframe>
      </div>
      <div className='w-10/12 md:w-9/12 mx-auto border-2 border-red-200 p-5 text-lg'>
      ...
      <h2 className='text-center text-2xl my-8 text-black font-semibold'>Cooking Instructions</h2>
